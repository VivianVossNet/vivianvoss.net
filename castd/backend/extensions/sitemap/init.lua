...
local pages = {
    ...
    { loc = "/blog/technical-beauty-ffmpeg",  priority = "0.7", changefreq = "yearly" },
    { loc = "/blog/the-jails-replacement",    priority = "0.7", changefreq = "yearly" },
    { loc = "/blog/the-rust-replacement",     priority = "0.7", changefreq = "yearly" },
    { loc = "/blog/bytes-of-art-scene-is-dead", priority = "0.7", changefreq = "yearly" },
